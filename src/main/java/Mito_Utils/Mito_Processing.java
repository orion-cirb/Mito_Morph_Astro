...
public class Mito_Processing {
    ...
    // Mito filter size
    private final double minMito = 1;
    ...
    */
    ...
    public Objects3DPopulation find_Mito(ImagePlus img, Roi roi) {
        ...
        // filter size
        clij2.excludeLabelsOutsideSizeRange(imgLabelled, labelsSizeFilter, minMito/(cal.pixelWidth*cal.pixelWidth*cal.pixelDepth),
                maxMito/(cal.pixelWidth*cal.pixelWidth*cal.pixelDepth));
